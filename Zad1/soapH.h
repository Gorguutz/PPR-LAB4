...
#ifndef SOAP_TYPE_ns1__simpleService_DEFINED
#define SOAP_TYPE_ns1__simpleService_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__simpleService(struct soap*, struct ns1__simpleService *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__simpleService(struct soap*, const struct ns1__simpleService *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__simpleService(struct soap*, const char*, int, const struct ns1__simpleService *, const char*);
SOAP_FMAC3 struct ns1__simpleService * SOAP_FMAC4 soap_in_ns1__simpleService(struct soap*, const char*, struct ns1__simpleService *, const char*);

SOAP_FMAC3 struct ns1__simpleService * SOAP_FMAC4 soap_new_ns1__simpleService(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__simpleService(struct soap*, const struct ns1__simpleService *, const char*, const char*);

#ifndef soap_write_ns1__simpleService
#define soap_write_ns1__simpleService(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns1__simpleService(soap, data), 0) || soap_put_ns1__simpleService(soap, data, "ns1:simpleService", "") || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns1__simpleService * SOAP_FMAC4 soap_get_ns1__simpleService(struct soap*, struct ns1__simpleService *, const char*, const char*);

#ifndef soap_read_ns1__simpleService
#define soap_read_ns1__simpleService(soap, data) ( ((data) ? (soap_default_ns1__simpleService(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns1__simpleService(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE_ns1__simpleServiceResponse_DEFINED
#define SOAP_TYPE_ns1__simpleServiceResponse_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__simpleServiceResponse(struct soap*, struct ns1__simpleServiceResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__simpleServiceResponse(struct soap*, const struct ns1__simpleServiceResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__simpleServiceResponse(struct soap*, const char*, int, const struct ns1__simpleServiceResponse *, const char*);
SOAP_FMAC3 struct ns1__simpleServiceResponse * SOAP_FMAC4 soap_in_ns1__simpleServiceResponse(struct soap*, const char*, struct ns1__simpleServiceResponse *, const char*);

SOAP_FMAC3 struct ns1__simpleServiceResponse * SOAP_FMAC4 soap_new_ns1__simpleServiceResponse(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__simpleServiceResponse(struct soap*, const struct ns1__simpleServiceResponse *, const char*, const char*);

#ifndef soap_write_ns1__simpleServiceResponse
#define soap_write_ns1__simpleServiceResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns1__simpleServiceResponse(soap, data), 0) || soap_put_ns1__simpleServiceResponse(soap, data, "ns1:simpleServiceResponse", "") || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns1__simpleServiceResponse * SOAP_FMAC4 soap_get_ns1__simpleServiceResponse(struct soap*, struct ns1__simpleServiceResponse *, const char*, const char*);

#ifndef soap_read_ns1__simpleServiceResponse
#define soap_read_ns1__simpleServiceResponse(soap, data) ( ((data) ? (soap_default_ns1__simpleServiceResponse(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns1__simpleServiceResponse(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
